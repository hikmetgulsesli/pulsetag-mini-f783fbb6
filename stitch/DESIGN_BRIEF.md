...
- PulseTag Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called PulseTag Mini. It should manage four tags, toggle active/warn/fail states, persist to localStorage, expose window.app state, and export a JSON summary. Keep it static HTML/CSS/JS only.
...
- Four Operations - PulseTag Mini
- Four Editor - PulseTag Mini
- Insights - PulseTag Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Four Operations - PulseTag Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Four Editor - PulseTag Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - PulseTag Mini
